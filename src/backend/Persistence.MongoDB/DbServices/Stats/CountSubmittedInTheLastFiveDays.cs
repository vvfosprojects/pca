//-----------------------------------------------------------------------
// <copyright file="CountSubmittedInTheLastFiveDays.cs" company="CNVVF">
...
{
    internal class CountSubmittedInTheLastFiveDays
    {
        private readonly DbContext dbContext;

        public CountSubmittedInTheLastFiveDays(DbContext dbContext)
        {
