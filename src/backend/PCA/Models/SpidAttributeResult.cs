...
{
    public class SpidAttributeResult
    {
        public SpidAttributeResult(bool success, string message, SpidAttribute spidAttribute)
        {
            Success = success;
            Message = message;
            SpidAttribute = spidAttribute;
        }

        public bool Success { get; }
        public string Message { get; }
        public SpidAttribute SpidAttribute { get; }
