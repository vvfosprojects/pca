...
namespace DotNetCasClient.Configuration
{
    ...
    public class CasClientConfiguration : ConfigurationSection
    {
        ...
        public const string CAS_CLIENT_URL = "casClientUrl";
        ...
        /// <summary>
        /// Defines the exact CAS client login URL.
        /// </summary>
        [ConfigurationProperty(CAS_CLIENT_URL, IsRequired = false)]
        public string CasClientUrl
        {
            get
            {
                return this[CAS_CLIENT_URL] as string;
            }
        }
