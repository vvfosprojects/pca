...
namespace DotNetCasClient
{
    ...
    public sealed class CasAuthentication
    {
        ...
        private static string casClientUrl;
            ...
            if (!initialized)
            {
                lock (LockObject)
                {
                    if (!initialized)
                    {
                        ...
                        casClientUrl = CasClientConfig.CasClientUrl;
                        configLogger.Info("casClientUrl = " + casClientUrl);
...
#region Properties
        ...
        /// URL of CAS lient.
        /// </summary>
        public static string CasClientUrl
        {
            get
            {
                Initialize();
